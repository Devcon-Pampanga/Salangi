    ...
    return(
        ...
        >
            ...
            <div className = "motion-preset-slide-right motion-duration-800">
                <h1 className = "font-['Playfair_Display'] translate-x-30 mt-70 text-[80px] absolute font-bold text-[#FBFAF8] max-w-120 leading-none">
            ...
            <div className = "motion-preset-slide-left motion-duration-800">
                <div className = "ml-180 mt-25 absolute">
                    ...
                    <p className = "text-[#FBFAF8] text-s">Find more local experiences.</p>
                </div>
