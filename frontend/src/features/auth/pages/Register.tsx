            ...
            <div className="space-y-4 lg:space-y-6">
              ...
              <div className="pt-4 space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  {tosError && (
                    <p className="text-red-400 text-xs pl-7">Please accept the Terms of Service to continue with Google.</p>
                  )}
                </div>
                    ...
                    >
                      ...
                      <div className="overflow-y-auto px-5 py-4 space-y-5 text-[#FBFAF8]/60 text-xs leading-relaxed">
                        ...
                        <div className="bg-[#C85B28]/10 border border-[#C85B28]/20 rounded-xl px-4 py-3">
                          <p className="text-[#FFE2A0] text-xs"><span className="font-semibold">Summary:</span> By registering, you agree to be respectful, honest, and not misuse the platform. Business owners are responsible for the accuracy of their listings. Salangi may feature your business in social media marketing.</p>
                        </div>
                        ...
                        {[
                          ...
                          { num: '02', title: 'Description of Service', body: 'Salangi is a community discovery platform that helps locals and tourists explore authentic Kapampangan food, crafts, cafés, events, and local businesses across Pampanga, Philippines. Features include a map-based business directory, business owner dashboard, event listings, and a save/bookmark feature.' },
                          { num: '03', title: 'User Accounts', body: 'You agree to provide accurate information during registration, maintain the security of your credentials, and be responsible for all activity that occurs under your account. We reserve the right to suspend accounts that violate these Terms.' },
                          { num: '04', title: 'Business Listings', body: 'Business owners must ensure all listing information is accurate and up to date. Listings are subject to admin review and approval. Photos and media must be content you have rights to use. Salangi reserves the right to remove listings containing false or harmful information.' },
                          { num: '05', title: 'User Content', body: 'By submitting reviews, photos, or other content, you grant Salangi a non-exclusive, royalty-free license to use and display that content on the Platform. Reviews must reflect genuine, firsthand experiences. Content must not be hateful, defamatory, or harmful.' },
                          ...
                          { num: '07', title: 'Privacy & Data', body: 'Salangi collects account data, session tokens, and aggregated analytics. We do not sell your personal data to third parties. Email communications are sent via Resend for verification and notifications.' },
                          { num: '08', title: 'Social Media Marketing', body: 'By listing your business on Salangi, you grant Salangi the right to feature your business — including its name, photos, description, and location — in social media marketing and promotional activities on platforms including Facebook, Instagram, and TikTok. This includes spotlights, community highlights, and promotional campaigns. No payment is involved. You may contact us to opt out at any time.' },
                          { num: '09', title: 'Disclaimers & Liability', body: 'Salangi is provided "as is." We make no warranties regarding the accuracy of listings. Salangi is not liable for indirect or consequential damages, the conduct of listed businesses, or Platform downtime. These Terms are governed by the laws of the Republic of the Philippines.' },
                        ].map(s => (
                          <div key={s.num}>
