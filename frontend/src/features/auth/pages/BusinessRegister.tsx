...
function BusinessRegister() {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    try {
      const res = await registerUser({ ...formData, role: 'business' });
        ...
        <div className="w-full max-w-md">
          ...
          <div className="flex gap-4">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 bg-[#2E2E2E] hover:bg-[#3a3a3a] text-white py-3 rounded-lg transition-colors border border-gray-600"
            >
