    ...
    return(
        <div className="w-full h-full">
            ...
            <div>
                ...
                <div className = "flex flex-col lg:flex-row gap-3 justify-center px-6 py-4">
                ...
                <div className = "flex flex-col lg:flex-row gap-3 justify-center px-6 py-2">
                    ...
                    <div className = "w-full h-full space-y-2 bg-[#3a3a3a] rounded-xl border border-[#4d4d4d] px-6 py-4">
                        ...
                        <div className = "grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            className="flex flex-row items-center gap-4 w-full px-6 py-4 bg-[#5a5241] hover:bg-[#857657] border border-[#FFE2A0] rounded-xl leading-tight cursor-pointer text-left transition-colors">
                            ...
                            <button className="flex flex-row items-center gap-4 w-full px-6 py-4 bg-[#5a5241] hover:bg-[#857657] border border-[#FFE2A0] rounded-xl leading-tight cursor-pointer text-left transition-colors">
                                <div className = "p-3 h-13 flex justify-center items-center bg-[#474133] rounded-xl">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" className = "size-5 text-white">
                    ...
                    <div className = "w-full h-full space-y-2 bg-[#3a3a3a] rounded-xl border border-[#4d4d4d] px-6 py-4">
                        ...
                        <div className = "space-y-2 mt-4">
                            ...
                            <div className="w-full h-px bg-[#4b4b4b]"></div>
