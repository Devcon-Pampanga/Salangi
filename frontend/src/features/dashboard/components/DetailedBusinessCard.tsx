                ...
                <div className="relative group w-full h-72 overflow-hidden bg-zinc-800">
                    ...
                    {images.length > 1 && (
                        <>
                            <button 
                                onClick={prevImage}
                                className="absolute left-2 top-1/2 -translate-y-1/2 w-8 h-8 flex items-center justify-center bg-[#222222]/50 hover:bg-[#222222]/80 backdrop-blur-sm rounded-full text-white opacity-0 group-hover:opacity-100 transition-opacity duration-200 cursor-pointer"
                            >
                                <ChevronLeft size={20} />
                            </button>
                            <button 
                                onClick={nextImage}
                                className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 flex items-center justify-center bg-[#222222]/50 hover:bg-[#222222]/80 backdrop-blur-sm rounded-full text-white opacity-0 group-hover:opacity-100 transition-opacity duration-200 cursor-pointer"
                            >
                ...
                <div className="p-6">
                    ...
                    <div className="flex flex-col gap-1 py-4 border-b border-zinc-600/50">
                        {phone && (
                            <div 
                                ...
                                className="relative flex items-center gap-4 text-sm text-[#FBFAF8]/80 hover:text-[#FBFAF8] px-3 py-2.5 rounded-xl border border-transparent hover:border-[#FFE2A0] hover:bg-[#FFE2A0]/5 hover:shadow-lg transition-all duration-300 cursor-pointer group"
                            >
                                <img src={callIcon} width="16" className="opacity-70 group-hover:opacity-100 transition-opacity" alt="call" />
                                <span>{phone}</span>
                                {copyFeedback === 'phone' && (
                                    <span className="absolute right-4 text-[10px] text-[#FFE2A0] font-bold animate-in fade-in slide-in-from-right-1 duration-200">
                                        Copied!
                                    </span>
                                )}
                            </div>
                        ...
                        {email && (
                            <div 
                                ...
                                className="relative flex items-center gap-4 text-sm text-[#FBFAF8]/80 hover:text-[#FBFAF8] px-3 py-2.5 rounded-xl border border-transparent hover:border-[#FFE2A0] hover:bg-[#FFE2A0]/5 hover:shadow-lg transition-all duration-300 cursor-pointer group"
                            >
                                <img src={emailIcon} width="16" className="opacity-70 group-hover:opacity-100 transition-opacity" alt="email" />
                                <span>{email}</span>
                                {copyFeedback === 'email' && (
                                    <span className="absolute right-4 text-[10px] text-[#FFE2A0] font-bold animate-in fade-in slide-in-from-right-1 duration-200">
                                        Copied!
                        ...
                        {facebook && (
                            <div 
                                ...
                                className="relative flex items-center gap-4 text-sm text-[#FBFAF8]/80 hover:text-[#FBFAF8] px-3 py-2.5 rounded-xl border border-transparent hover:border-[#FFE2A0] hover:bg-[#FFE2A0]/5 hover:shadow-lg transition-all duration-300 cursor-pointer group"
                            >
                                <img src={facebookIcon} width="16" className="opacity-70 group-hover:opacity-100 transition-opacity" alt="fb" />
                                <span>{facebook}</span>
                            </div>
                        )}
                        {website && (
                            <div 
                                ...
                                className="relative flex items-center gap-4 text-sm text-[#FBFAF8]/80 hover:text-[#FBFAF8] px-3 py-2.5 rounded-xl border border-transparent hover:border-[#FFE2A0] hover:bg-[#FFE2A0]/5 hover:shadow-lg transition-all duration-300 cursor-pointer group"
                            >
                                <img src={websiteIcon} width="16" className="opacity-70 group-hover:opacity-100 transition-opacity" alt="web" />
                                <span>{website}</span>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="py-6">
                        ...
                        <div className="flex flex-col">
                            <span className="text-5xl font-serif text-[#FBFAF8]">{rating.toFixed(1)}</span>
